...
| ] | If current cell value != 0, goto cell after corresponding [ command. | currentCellValue |
| , | Take input from user and set current and following cells to either (left, right, up, down, enter) or (analogInput1, analogInput2, enter). | mode |
| . | Output integer or character at character (x, y) on display. | currentCellValue, mode, x, y |
...
| = | Set value of current cell to value of cell (cell). |  currentCellValue |
